...
async fn account_profile() {
    // Run some test cases
    let result = LI.account().profile().await;
    assert!(
        result.is_ok(),
    ...
    let result = BOT0.account().profile().await;
    assert!(
        result.is_ok(),
        "Failed to get profile information: {:?}",
        result.unwrap_err().source().unwrap()
...
async fn account_preferences() {
    // Run some test cases
    let result = LI.account().preferences().await;
    assert!(
        result.is_ok(),
    ...
    let result = BOT0.account().preferences().await;
    assert!(
        result.is_ok(),
        "Failed to get account preferences: {:?}",
        result.unwrap_err().source().unwrap()
...
async fn account_kid_mode() {
    // Run some test cases
    let result = LI.account().kid_mode().await;
    assert!(
        result.is_ok(),
    ...
    let result = BOT0.account().kid_mode().await;
    assert!(
        result.is_ok(),
        "Failed to check account kid mode: {:?}",
        result.unwrap_err().source().unwrap()
...
async fn account_kid_mode_set() {
    // Run some test cases
    let result = LI.account().kid_mode_set(false).await;
    assert!(
        result.is_ok(),
    ...
    let result = BOT0.account().kid_mode_set(false).await;
    assert!(
        result.is_ok(),
        "Failed to set account kid mode: {:?}",
        result.unwrap_err().source().unwrap()
...
async fn account_timeline() {
    // Run some test cases
    let result = LI.account().timeline(None, None).await;
    assert!(
        result.is_ok(),
    ...
    let result = LI.account().timeline(Some(1704060000000), Some(10)).await;
    assert!(
        result.is_ok(),
        "Failed to get account timeline: {:?}",
        result.unwrap_err().source().unwrap()
    ...
    let result = BOT0.account().timeline(Some(1704060000000), Some(30)).await;
    assert!(
        result.is_ok(),
        "Failed to get account timeline: {:?}",
        result.unwrap_err().source().unwrap()
