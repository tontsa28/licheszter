...
impl Licheszter {
    ...
    pub async fn board_seek_create(
        ...
        let url = self.request_url(UrlBase::Lichess, "api/board/seek");
    ...
    pub async fn board_game_connect(
        ...
        let url = self.request_url(
            UrlBase::Lichess,
            &format!("api/board/game/stream/{game_id}"),
        );
    ...
    pub async fn board_play_move(
        ...
        let url = self.request_url(
            UrlBase::Lichess,
            &format!("api/board/game/{game_id}/move/{uci_move}"),
        );
    ...
    pub async fn board_chat_write(&self, game_id: &str, room: ChatRoom, text: &str) -> Result<()> {
        let url = self.request_url(UrlBase::Lichess, &format!("api/board/game/{game_id}/chat"));
        let builder = self
            .client
            .post(url)
    ...
    pub async fn board_game_abort(&self, game_id: &str) -> Result<()> {
        let url = self.request_url(UrlBase::Lichess, &format!("api/board/game/{game_id}/abort"));
    ...
    pub async fn board_game_resign(&self, game_id: &str) -> Result<()> {
        let url = self.request_url(
            UrlBase::Lichess,
            &format!("api/board/game/{game_id}/resign"),
        );
        let builder = self.client.post(url);
    ...
    pub async fn board_handle_draws(&self, game_id: &str, accept: bool) -> Result<()> {
        let url = self.request_url(
            UrlBase::Lichess,
            &format!("api/board/game/{game_id}/draw/{accept}"),
        );
        let builder = self.client.post(url);
    ...
    pub async fn board_handle_takebacks(&self, game_id: &str, accept: bool) -> Result<()> {
        let url = self.request_url(
            UrlBase::Lichess,
            &format!("api/board/game/{game_id}/takeback/{accept}"),
        );
        let builder = self.client.post(url);
    ...
    pub async fn board_claim_victory(&self, game_id: &str) -> Result<()> {
        let url = self.request_url(
            UrlBase::Lichess,
            &format!("api/board/game/{game_id}/claim-victory"),
        );
        let builder = self.client.post(url);
    ...
    pub async fn board_berserk(&self, game_id: &str) -> Result<()> {
        let url = self.request_url(
            UrlBase::Lichess,
            &format!("api/board/game/{game_id}/berserk"),
        );
        let builder = self.client.post(url);
