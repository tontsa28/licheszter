...
impl BoardApi {
    ...
    pub async fn seek_create(&self, options: Option<&SeekOptions>) -> Result<Pin<Box<dyn Stream<Item = Result<()>> + Send>>> {
    ...
    pub async fn game_connect(&self, game_id: &str) -> Result<Pin<Box<dyn Stream<Item = Result<BoardState>> + Send>>> {
        let url = self.inner.req_url(UrlBase::Lichess, &format!("api/board/game/stream/{game_id}"));
    ...
    pub async fn play_move(&self, game_id: &str, uci_move: &str, draw_offer: bool) -> Result<()> {
        let url = self.inner.req_url(UrlBase::Lichess, &format!("api/board/game/{game_id}/move/{uci_move}"));
    ...
    pub async fn chat_write(&self, game_id: &str, room: ChatRoom, text: &str) -> Result<()> {
        let url = self.inner.req_url(UrlBase::Lichess, &format!("api/board/game/{game_id}/chat"));
    ...
    pub async fn game_abort(&self, game_id: &str) -> Result<()> {
        let url = self.inner.req_url(UrlBase::Lichess, &format!("api/board/game/{game_id}/abort"));
    ...
    pub async fn game_resign(&self, game_id: &str) -> Result<()> {
        let url = self.inner.req_url(UrlBase::Lichess, &format!("api/board/game/{game_id}/resign"));
        let builder = self.inner.client.post(url);
    ...
    pub async fn handle_draws(&self, game_id: &str, accept: bool) -> Result<()> {
        let url = self.inner.req_url(UrlBase::Lichess, &format!("api/board/game/{game_id}/draw/{accept}"));
        let builder = self.inner.client.post(url);
    ...
    pub async fn claim_victory(&self, game_id: &str) -> Result<()> {
        let url = self.inner.req_url(UrlBase::Lichess, &format!("api/board/game/{game_id}/claim-victory"));
        let builder = self.inner.client.post(url);
    ...
    pub async fn claim_draw(&self, game_id: &str) -> Result<()> {
        let url = self.inner.req_url(UrlBase::Lichess, &format!("api/board/game/{game_id}/claim-draw"));
        let builder = self.inner.client.post(url);
    ...
    pub async fn berserk(&self, game_id: &str) -> Result<()> {
        let url = self.inner.req_url(UrlBase::Lichess, &format!("api/board/game/{game_id}/berserk"));
        let builder = self.inner.client.post(url);
